...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mt-4 mb-3">
        <h1 class="mb-0"><?= esc($title ?? 'Counties') ?></h1>
        <a href="<?= base_url('admin/counties/add') ?>" class="btn btn-primary">
            <i class="fas fa-plus me-1"></i> Add County
        </a>
    </div>
    <hr>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <?php if (!empty($counties) && count($counties) > 0): ?>
            ...
            <?php else: ?>
                <p class="text-muted text-center mb-0">No counties found.</p>
            <?php endif; ?>
        </div>
    </div>
</div>
